...
int main(int argc, char* argv[]) {
    ...
    if (argc >= 2) {
        // Мменяем хост, если предоставлен соответствующий аргумент командной строки.
    ...
    // Адрес подключения пррямо в формате хост:порт.
    ...
    // теперь отправляем GET запрос для остановки сервера.
